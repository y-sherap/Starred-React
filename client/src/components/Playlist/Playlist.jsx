...
const Playlist = ({
  ...
  return (
    <div
      ...
      onMouseOut={() => updateHover(false, index)}
    >
      <img
        src={playlist.image}
        alt="playlist image"
      ...
      {isHover ? (
        <div>
          {isEdit ? (
            ...
            <h3 onClick={() => goToPlaylist(playlist)} className="playlistName">
              {playlist.name}
            </h3>
          )}
          ...
          <div className="playlistCardUpdateForm">
            {isEdit ? (
              <div id="playlistUpdateFormFields">
                ...
                <input
                  type="text"
                  placeholder="Playlist Mood"
                  onChange={(e) => moodHandler(e)}
                ></input>
                <input
                  type="text"
                ...
                <button
                  onClick={() =>
                    updatePlaylist(playlist, index, newName, newMood, newImg)
                  }
                >
                  Save Update
                </button>
